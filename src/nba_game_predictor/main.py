...
# avg_scoring_marigin = statistics.get_average_scoring_marigin(1,atlanta_hawks_game_ids_list)
# statistics.add_to_csv(list=avg_scoring_marigin,statistic="scoring_marigin", team=next(iter(statistics.team_ids[0].keys())))
